 ...
 */
export default class Petrallengine {
    static readonly BUILD = 1;
    static readonly VERSION = "0.0.1";
    static readonly FRAME_RATE = 60;
    static readonly FRAME_TIME = 1 / Petrallengine.FRAME_RATE;

    private static gameTime = 0;
    private static rootNode: Node = new Node(Petrallengine);

    /** The root node of the whole game. */
    static get root() {
        return Petrallengine.rootNode;
    }
    ...
    static create(target?: HTMLCanvasElement) {
        console.debug(`%cPetrallengine v${Petrallengine.VERSION}\nby Petraller`, 'color: #0799ce');
        ...
        const ft = 1000 / Petrallengine.FRAME_RATE;
        const gameLoop = () => {
            ...
            Petrallengine.gameTime += dt + wait;
