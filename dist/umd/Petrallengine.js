(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Petrallengine = {}));
    ...
    */
    class RigidBody extends Body {
        ...
        addForce(force, type = exports.EForceType.Impulse) {
            let a;
            switch (type) {
                case exports.EForceType.Impulse:
                    a = Vec2.multiply(force, 1 / this.mass);
                    break;
                case exports.EForceType.Force:
    ...
    */
    ...
    exports.Vec2 = Vec2;
    exports.makeSnowflake = makeSnowflake;
